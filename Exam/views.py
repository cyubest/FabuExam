...
from .models import Student, Room, Exam, Course
...
from .serializers import ExamSerializers, UserSerializer, LoginUserSerializer
...
class LoginAPI(KnoxLoginView):
    ...
    def post(self, request, format=None):
        ...
        return Response({"data": login_details.data, "user": login_deta.data})
...
@api_view(['GET'])
def get_student_examTimetable(request):
